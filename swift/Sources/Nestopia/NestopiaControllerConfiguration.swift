...
public enum NestopiaControllerTheme: Sendable, Equatable {
...
public enum NestopiaControllerPresentationMode: Sendable, Equatable {
...
public struct NestopiaControllerColorOverrides {
...
public struct NestopiaControllerConfiguration {
    public var theme: NestopiaControllerTheme
    public var presentationMode: NestopiaControllerPresentationMode
    public var colors: NestopiaControllerColorOverrides
    ...
    public init(
        theme: NestopiaControllerTheme = .system,
        presentationMode: NestopiaControllerPresentationMode = .automatic,
        colors: NestopiaControllerColorOverrides = .init(),
